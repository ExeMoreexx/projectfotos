...
@section('title', 'Agregar Foto Pasaporte')
@section('content')
...
<div class="card mt-5 shadow-lg p-3 mb-5 bg-body rounded position-absolute top-0 start-50 translate-middle-x" style="width: 28rem">
    <div class="card-body">
        <h4 class="modal-title mb-3">Foto Pasaporte</h4>
        <form action="{{ route('fotos.store_pasaporte') }}" method="post" enctype="multipart/form-data">
        @csrf
            <div class="mb-3">
