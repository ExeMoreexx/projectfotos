...
@section('title', 'Agregar Foto Infantil Larga')
@section('content')
...
<div class="card mt-5 shadow-lg p-3 mb-5 bg-body rounded position-absolute top-0 start-50 translate-middle-x" style="width: 28rem">
    <div class="card-body">
        <h4 class="modal-title mb-3">Foto Infantil Larga</h4>
        <form action="{{ route('fotos.store_infantil_larga') }}" method="post" enctype="multipart/form-data">
        @csrf
            <div class="mb-3">
        ...
        <div class="input-group mb-3">
          ...
          <div class="mb-3">
            <input type="text" hidden id="precio" name="precio" class="form-control text-center" value="$ 75">
          </div>
